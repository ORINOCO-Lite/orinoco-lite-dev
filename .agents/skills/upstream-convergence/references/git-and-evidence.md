...
- package compatibility declarations and bundled resource inputs;
...
Compare the package artifacts and their bundled resources, including the editor shell, licenses, notices, and schema closure, byte-for-byte.
...
- exact package, tool, assembly assertion, and consumer-template pins plus regenerated locks, with the observed Annex state when Annex was used;
