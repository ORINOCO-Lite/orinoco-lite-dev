...
| `dump-research-info` source correction | ready pull request [`con/dump-research-info#26`](https://github.com/con/dump-research-info/pull/26), base `397b56080d14aeb94592f308b2f0bf325a298c13`, head `efe603f16875ad9798c6ce04aaf35d0a0d5404a0`, source tree `29f90931d6e42fee0473d751e2e0e89ae5c6872e` | Removed 70 presentation-routing `about` values, retained qualified homepages, added the CON homepage, and bounded missing GitHub, ORCID, ISSN International Centre, and author-role identities without importing provider graphs. The JMLR identifier now reuses the existing venue Thing. `uv run --group test pytest` passed 29 tests, mypy passed, and pull-request CI passed on Linux, macOS, and Windows. |
| `dump-research-info` proposal | workflow run [32865096194](https://github.com/leej3/orinoco-lite-demo/actions/runs/32865096194), draft pull request [13](https://github.com/leej3/orinoco-lite-demo/pull/13), base `5cb8c406bcb02cac5d98aae4a3afae2bd4a9191b`, DataLad proposal `9f3b0217410d134a167e67db017b9783fe9fb784`, tree `4c1e9269c548b1e5c49ef012ac2e838b3e64d19f` | Exact source coordinate is `{"commit":"efe603f16875ad9798c6ce04aaf35d0a0d5404a0","repository":"https://github.com/con/dump-research-info","source_directory":"data/con_site","tree":"29f90931d6e42fee0473d751e2e0e89ae5c6872e"}`. The one-parent proposal has 85 candidates and an actual 170-file metadata diff with 3,374 additions and no deletions. |
| `dump-research-info` decision-review artifact | [artifact 9569769136](https://github.com/leej3/orinoco-lite-demo/actions/runs/32865096194/artifacts/9569769136), `orinoco-curation-review-9f3b0217410d134a167e67db017b9783fe9fb784`, 8,478 bytes, ZIP digest `sha256:6b9364e3f6898f8be5318f0bad46817bac20264b38ba927db30504503f3ec279`, extracted JSON SHA-256 `deca0b7f03fb76a145f9ed8169cf5ac6f7ed01b95f4b7d522c8e1a8ca37580a3`, expiry `2026-11-23T15:19:43Z` | The authenticated [central review route](https://orinoco-curation-review.pages.dev/review/?repository=leej3%2Forinoco-lite-demo&pull_request=13&artifact_id=9569769136) loaded all 85 records as `leej3`, exposed 255 mutually exclusive controls, filtered `ORCID` to one record, showed `0/85` complete, and posted no decision. |
| `dump-research-info` exact-head SHACL input | run [32865188384](https://github.com/leej3/orinoco-lite-demo/actions/runs/32865188384), [artifact 9569879624](https://github.com/leej3/orinoco-lite-demo/actions/runs/32865188384/artifacts/9569879624), `orinoco-shacl-vue-input-9f3b0217410d134a167e67db017b9783fe9fb784`, 328,231 bytes, digest `sha256:514bc611c14cd104a37a7c1895a9cfd924e536e97e7fb0f6aa61f24458cb5724`, expiry `2026-11-23T15:20:36Z` | Trusted default-branch code validated the exact joined graph, published the expiring input, and posted the [attributed edit link](https://github.com/leej3/orinoco-lite-demo/pull/13#issuecomment-5412676625). No handoff commit was created. |
| `dump-research-info` proposal-head CI | run [32865185591](https://github.com/leej3/orinoco-lite-demo/actions/runs/32865185591), static-site [artifact 9570103691](https://github.com/leej3/orinoco-lite-demo/actions/runs/32865185591/artifacts/9570103691), digest `sha256:8eaf88a07b24a99bfbbfb3b50e36542504124356ed15700faf4a58fc8df47e75` | Both supported platforms passed 136 Python tests, Chromium 2/2, WebKit 2/2, 226-record/85-companion joined validation with 418 annotation assertions, and deterministic 572-file tree `bb793aa490438faaca637554071be274aa2362b7f823beb39cde455f22887276`. |
...
Pull requests 7 and 13 are the current Zotero and `dump-research-info` review entry points.
...
| No local requirement | An authorized reviewer completes the normal workflow through the linked web application and GitHub without a checkout. | the central application authenticated `leej3` and loaded all 85 pull request 13 records; decision completion remains human-owned and pending |
...
| Exact editor state | Existing-PR editing is bound to its exact head and standalone editing to an exact default-branch commit. | app tree `57eab1253fcb668d7822973cf158feadfb67c1bf`; real pull requests 29, 7, and 13 produced exact-head artifacts and attributed links |
...
- personal demonstration fixture pull requests 6, 10, and 12, latest merge `5cb8c406bcb02cac5d98aae4a3afae2bd4a9191b`, dump proposal pull request 13 at `9f3b0217410d134a167e67db017b9783fe9fb784`, and rollback parent `9b178b49099d37e5bd10cc128962aea8b8b0d89a`;
...
Authentication and record rendering are proven for pull request 13; dispositions, submission, finalization, and curation merges remain entirely human-owned.
...
Milestone 5 implementation and distribution are complete through the development repositories, the central service is deployed, the App permission update is installed on the isolated public demo, and real Zotero and `dump-research-info` proposals are open with green exact-head evidence.
Exit remains pending on review and merge of the separate corpus normalization, an authenticated human decision submission/finalization and same-source rerun, one explicit SHACL handoff, and merge of the `dump-research-info` source correction.
