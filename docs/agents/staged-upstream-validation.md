...
The directory contains `review.json` with a snapshot of the supplied decisions, copied reports, and relative artifact paths; it is untracked generated output.
