...
The engineering candidate task creates a fresh disposable Copier instance, applies a selected downstream's declared inputs, and tests selected package and template working trees together.
