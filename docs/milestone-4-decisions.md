...
| M4-I013 | Pull request 1 is closed, unmerged discovery evidence. Replacement pull request 2 at `652c7702d9b62126013f003cc4742969d5400347` is the only pending publication candidate. | Human review and merge, default-main validation, Pages deployment, and published project-path proof remain mandatory acceptance gates. |
