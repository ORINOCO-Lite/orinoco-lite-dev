...
| M5-D014 | SHACL Vue proposal editing is a distinct human-edit profile, not an input to the hosted decision-review bundle or finalizer. | The current App retains contents read access. A separately reviewed wrapper may later add explicit, path-restricted human proposal writes while leaving GitHub, source-adapter, disposition, provenance, and decision-cache semantics outside SHACL Vue. |
...
M5-D001 through M5-D014 refine M4-I003, M4-I008, M4-I014, and M4-I015 and implement HR-201, HR-207, HR-208, HR-209, and HR-212 for source-adapter operation.
