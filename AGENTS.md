...
- Test unreleased package and template work together by injecting compact mock site data into a fresh disposable template instance with `pixi run test-downstream-candidate` when practical.
