...
Component licenses apply only to their respective components; downstream metadata, editorial content, media, and website styling retain their own declared terms.
