...
def fixture(tmp_path, *, homepage=True):
    ...
    (source / "page_templates/person.md.j2").write_text('{{ annotations.label }}')
    ...
    records = [
        {"pid": "xyzrins:persons/local", "schema_type": "xyzri:XYZPerson", "annotations": {"label": {"annotation_value": "Local"}}},
        {"pid": "xyzrins:persons/other", "schema_type": "xyzri:XYZPerson", "annotations": {"label": "Other"}},
